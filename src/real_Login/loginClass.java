...
public class loginClass {
	...
	static String[][] fileReader() {
			...
			try {
	            ...
	            File myfile = new File("..\\files\\database.txt");
	...
	static void pleaseWork(String [] userDetails){
		...
		try {
			...
			FileWriter myWriter = new FileWriter("..\\files\\database.txt", true);
	...
	static void fileWrite(String [][] dataBase){
			...
			try {
				...
				FileWriter myWriter = new FileWriter("..\\files\\database.txt");
